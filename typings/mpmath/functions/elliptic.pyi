...
__all__: list[str] = ['RC_calc', 'RF_calc', 'RJ_calc', 'defun', 'defun_wrapped', 'ellipe', 'ellipf', 'ellipfun', 'ellippi', 'elliprc', 'elliprd', 'elliprf', 'elliprg', 'elliprj', 'eta', 'jacobi_spec', 'kfrom', 'kleinj', 'mfrom', 'nome', 'qbarfrom', 'qfrom', 'taufrom']
...
def taufrom(ctx, q = None, m = None, k = None, tau = None, qbar = None):
    ...
    """
jacobi_spec: dict = {'sn': ([3], [2], [1], [4], 'sin', 'tanh'), 'cn': ([4], [2], [2], [4], 'cos', 'sech'), 'dn': ([4], [3], [3], [4], '1', 'sech'), 'ns': ([2], [3], [4], [1], 'csc', 'coth'), 'nc': ([2], [4], [4], [2], 'sec', 'cosh'), 'nd': ([3], [4], [4], [3], '1', 'cosh'), 'sc': ([3], [4], [1], [2], 'tan', 'sinh'), 'sd': ([3, 3], [2, 4], [1], [3], 'sin', 'sinh'), 'cd': ([3], [2], [2], [3], 'cos', '1'), 'cs': ([4], [3], [2], [1], 'cot', 'csch'), 'dc': ([2], [3], [3], [2], 'sec', '1'), 'ds': ([2, 4], [3, 3], [3], [1], 'csc', 'csch'), 'cc': None, 'ss': None, 'nn': None, 'dd': None}
