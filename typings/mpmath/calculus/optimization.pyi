...
import typing
__all__: list[str] = ['ANewton', 'Anderson', 'Bisection', 'Halley', 'Illinois', 'MDNewton', 'MNewton', 'Muller', 'Newton', 'OptimizationMethods', 'Pegasus', 'Ridder', 'Secant', 'copy', 'findroot', 'jacobian', 'multiplicity', 'print_function', 'steffensen', 'str2solver', 'xrange']
class ANewton:
    """
    ...
    """
    maxsteps: typing.ClassVar[int] = 20
...
class Bisection:
    ...
    * needs sign change
    """
    maxsteps: typing.ClassVar[int] = 100
    def __init__(self, ctx, f, x0, **kwargs):
        ...
    def __iter__(self):
        ...
...
class Illinois:
    ...
    * needs sign change
    """
    maxsteps: typing.ClassVar[int] = 30
    def __init__(self, ctx, f, x0, **kwargs):
        ...
    def __iter__(self):
        ...
class MDNewton:
    ...
    """
    maxsteps: typing.ClassVar[int] = 10
    def __init__(self, ctx, f, x0, **kwargs):
        ...
    def __iter__(self):
        ...
...
str2solver: dict = {'newton': Newton, 'secant': Secant, 'mnewton': MNewton, 'halley': Halley, 'muller': Muller, 'bisect': Bisection, 'illinois': Illinois, 'pegasus': Pegasus, 'anderson': Anderson, 'ridder': Ridder, 'anewton': ANewton, 'mdnewton': MDNewton}
