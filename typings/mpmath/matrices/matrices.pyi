...
__all__: list[str] = ['MatrixMethods', 'colsep', 'rowsep', 'warnings', 'xrange']
class MatrixMethods:
    @staticmethod
    def __init__(ctx):
        ...
...
class _matrix:
    ...
    def _matrix__get_element(self, key):
        ...
        """
    def _matrix__getcols(self):
        ...
    def _matrix__getrows(self):
        ...
    def _matrix__set_element(self, key, value):
        ...
        """
    def _matrix__setcols(self, value):
        ...
    def _matrix__setrows(self, value):
        ...
