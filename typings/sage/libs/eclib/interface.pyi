from .mwrank import parse_point_list as parse_point_list
...
class mwrank_EllipticCurve(SageObject):
    ...
    """
    def __init__(self, ainvs, verbose: bool = False) -> None:
        """
        Create the mwrank elliptic curve with invariants
        ``ainvs``, which is a list of 5 or less *integers* `a_1`,
        `a_2`, `a_3`, `a_4`, and `a_5`.
    ...
    def ainvs(self):
        ...
        EXAMPLES::
            ...
            [0, 0, 1, -1, 0]
        """
    def isogeny_class(self, verbose: bool = False):
        """
        ...
        """
    def two_descent(self, verbose: bool = True, selmer_only: bool = False, first_limit: int = 20, second_limit: int = 8, n_aux: int = -1, second_descent: bool = True) -> None:
        """
    ...
    def regulator(self):
        ...
        EXAMPLES::
            ...
            0.05111140823996884
        """
    def saturate(self, bound: int = -1, lower: int = 2) -> None:
        """
...
class mwrank_MordellWeil(SageObject):
    ...
    """
    def __init__(self, curve, verbose: bool = True, pp: int = 1, maxr: int = 999) -> None:
        """
    ...
    def __reduce__(self):
        ...
        """
    def process(self, v, saturation_bound: int = 0) -> None:
    ...
    def rank(self):
        ...
        """
    def saturate(self, max_prime: int = -1, min_prime: int = 2):
        ...
        """
    def search(self, height_limit: int = 18, verbose: bool = False) -> None:
        """
