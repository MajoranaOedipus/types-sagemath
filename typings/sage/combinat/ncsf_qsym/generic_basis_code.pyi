...
class BasesOfQSymOrNCSF(Category_realization_of_parent):
    ...
    class ParentMethods:
        ...
        def alternating_sum_of_compositions(self, n):
            ...
            """
        def alternating_sum_of_finer_compositions(self, composition, conjugate: bool = False):
            """
        ...
        def degree_on_basis(self, I):
            ...
            EXAMPLES::
                ...
                0
            """
        def skew(self, x, y, side: str = 'left'):
            """
    ...
    class ElementMethods:
        ...
        def duality_pairing(self, y):
            ...
            ::
                ...
                1
            """
        def skew_by(self, y, side: str = 'left'):
            """
...
class AlgebraMorphism(ModuleMorphismByLinearity):
    ...
    """
    def __init__(self, domain, on_generators, position: int = 0, codomain=None, category=None, anti: bool = False) -> None:
        """
...
class GradedModulesWithInternalProduct(Category_over_base_ring):
    ...
    def super_categories(self):
        ...
        """
    class ParentMethods:
        def internal_product_on_basis(self, I, J) -> None:
            """
