...
def q_factorial(n, q=None):
    ...
    TESTS::
        ...
        Univariate Polynomial Ring in q over Integer Ring
    """
def q_binomial(n, k, q=None, algorithm: str = 'auto'):
    '''
    ...
    '''
def gaussian_binomial(n, k, q=None, algorithm: str = 'auto'):
    """
    ...
    EXAMPLES::
        ...
        q^4 + q^3 + 2*q^2 + q + 1
    """
def q_multinomial(seq, q=None, binomial_algorithm: str = 'auto'):
    """
...
def q_catalan_number(n, q=None, m: int = 1):
    """
...
def q_jordan(t, q=None):
    ...
    """
def q_subgroups_of_abelian_group(la, mu, q=None, algorithm: str = 'birkhoff'):
    """
...
def q_stirling_number2(n, k, q=None):
    ...
    - [Mil1978]_
    """
def number_of_irreducible_polynomials(n, q=None, m: int = 1):
    """
