...
from sage.combinat.words.finite_word import Factorization as Factorization, FiniteWord_class as FiniteWord_class
from sage.combinat.words.morphism import WordMorphism as WordMorphism
from sage.combinat.words.word import FiniteWord_list as FiniteWord_list
from sage.combinat.words.words import FiniteWords as FiniteWords, InfiniteWords as InfiniteWords
...
class LowerChristoffelWord(FiniteWord_list):
    ...
    TESTS::
        ...
        word: 01
    """
    def __init__(self, p, q, alphabet=(0, 1), algorithm: str = 'cf') -> None:
        """
        INPUT:
...
class WordGenerator:
    ...
    """
    def ThueMorseWord(self, alphabet=(0, 1), base: int = 2):
        """
        ...
        """
    def FibonacciWord(self, alphabet=(0, 1), construction_method: str = 'recursive'):
        '''
    ...
    def FixedPointOfMorphism(self, morphism, first_letter):
        ...
        ::
            ...
            word: abc
        """
    def CodingOfRotationWord(self, alpha, beta, x: int = 0, alphabet=(0, 1)):
        """
    ...
    def KolakoskiWord(self, alphabet=(1, 2)):
        ...
        '''
    def LowerMechanicalWord(self, alpha, rho: int = 0, alphabet=None):
        """
        ...
        """
    def UpperMechanicalWord(self, alpha, rho: int = 0, alphabet=None):
        """
    ...
    def MinimalSmoothPrefix(self, n):
        ...
        EXAMPLES::
            ...
            word: 1212212112
        """
    def RandomWord(self, n, m: int = 2, alphabet=None):
        '''
    ...
    LowerChristoffelWord : type[LowerChristoffelWord]
    ...
    def s_adic(self, sequence, letters, morphisms=None):
        ...
        '''
    def PalindromicDefectWord(self, k: int = 1, alphabet: str = 'ab'):
        """
