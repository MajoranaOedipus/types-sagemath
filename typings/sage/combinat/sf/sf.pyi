from . import elementary as elementary, hall_littlewood as hall_littlewood, homogeneous as homogeneous, jack as jack, llt as llt, macdonald as macdonald, monomial as monomial, powersum as powersum, schur as schur
...
class SymmetricFunctions(UniqueRepresentation, Parent):
    ...
    * Hecke character basis
    ...
    def orthogonal(self):
        ...
        """
    o = orthogonal
    def hecke_character(self, q: str = 'q'):
        """
    ...
    def macdonald(self, q: str = 'q', t: str = 't'):
        """
        ...
        EXAMPLES::
            ...
            z^2*s[1, 1, 1, 1] + (z^2*q+z*q+z)*s[2, 1, 1] + (z^2*q^2+1)*s[2, 2] + (z*q^2+z*q+q)*s[3, 1] + q^2*s[4]
        """
    def hall_littlewood(self, t: str = 't'):
        """
    ...
    def from_polynomial(self, f):
        ...
        """
    def register_isomorphism(self, morphism, only_conversion: bool = False) -> None:
        """
    ...
    def __init_extra__(self) -> None:
        ...
        EXAMPLES::
            ...
            True
        """
    def kBoundedSubspace(self, k, t: str = 't'):
        """
    ...
    def khomogeneous(self, k):
        ...
        EXAMPLES::
            ...
            h[4]
        """
    def kBoundedQuotient(self, k, t: str = 't'):
        """
