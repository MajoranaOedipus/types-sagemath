...
from sage.rings.semirings.non_negative_integer_semiring import NonNegativeIntegerSemiring as NonNegativeIntegerSemiring
...
class ShiftingOperatorAlgebra(CombinatorialFreeModule):
    ...
    We can also use raising operators to implement the Jacobi-Trudi identity::
        ...
        s[3, 2, 1]
    """
    def __init__(self, base_ring=..., prefix: str = 'S') -> None:
        """
        Initialize ``self``.
    ...
    def one_basis(self):
        ...
        EXAMPLES::
            ...
            ()
        """
    def build_and_register_conversion(self, support_map, codomain) -> None:
        """
