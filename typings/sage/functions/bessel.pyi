...
from sage.rings.infinity import (
    ...
    unsigned_infinity as unsigned_infinity,
)
...
class Function_Bessel_J(BuiltinFunction):
    ...
    def __call__[T: float | complex | _MpfrDoubleSage](
        self, nu: int | Integer, x: T, /, *, hold: bool = False
    ) -> T: ...
    # float
    @overload
    def __call__(
        self, nu: float, x: int | float | Integer | Rational, /, *, hold: bool = False
    ) -> float | complex: ...
    @overload
    def __call__(
        self,
        nu: float | Rational | _RealMpfrDoubleSage,
        x: complex,
        /,
        *,
        hold: bool = False,
    ...
    @overload
    def __call__(
        self, nu: float | Rational | RealNumber, x: RealNumber, /, *, hold: bool = False
    ...
    def __call__(
        ...
        x: _py_number | Integer | Rational | CommutativePolynomial | FloatingSage,
        /,
        *,
        hold: bool = False,
    ) -> Expression_[SymbolicRing]: ...
...
class Function_Bessel_Y(BuiltinFunction):
    ...
    def __call__(
        self, 
        nu: int | Integer | Rational, 
        x: int | Integer | Rational | _BallMpfiSage | _inf, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, nu: int | Integer | Rational, x: float, /, *, hold: bool = False
    ) -> complex | float: ...
    @overload
    def __call__[T: complex | _ComplexMpfrDoubleSage](
        self, nu: _py_number | Integer | Rational | _RealMpfrDoubleSage, x: T, 
        /, *, hold: bool = False) -> T: ...
    @overload
    def __call__(
    ...
    @overload
    def __call__(
        self, nu: int | Integer | Rational, x: CommutativePolynomial, /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(self, nu: int | Integer, x: RealNumber, /, *, hold: bool = False) -> RealNumber: ...
    @overload
    def __call__(
        self, nu: int | float | Integer | Rational, x: RealDoubleElement, 
        /, *, hold: bool = False
    ) -> _DoubleSage: ...
    # float / Rational
    @overload
    ...
    @overload
    def __call__(
        self, nu: float | complex | _MpfrDoubleSage, x: CommutativePolynomial, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
        self, nu: float | Rational, x: RealNumber, /, *, hold: bool = False
    ) -> _MpfrSage: ...
    @overload
    def __call__(
        self, nu: float | complex | CommutativePolynomial | FloatingSage, 
        x: _BallMpfiSage | _inf, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    # complex
    @overload
    def __call__(
        self, nu: complex, x: _py_number | Integer | Rational | _RealMpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> complex: ...
    # Polynomials
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: int | Rational | Integer | CommutativePolynomial, 
        /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
    ...
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: float | RealDoubleElement, /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: float, /, 
    ) -> Expression_[SymbolicRing] | CommutativePolynomial | complex: ...
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: RealNumber | _ComplexMpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: RealDoubleElement, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | CommutativePolynomial | ComplexDoubleElement: ...
    # RealNumber / RDF Number
    @overload
    def __call__(
        self, nu: RealNumber, x: int | float | Integer | Rational | _RealMpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> _MpfrSage: ...
    @overload
    def __call__(
        self, nu: RealDoubleElement, x: int | float | Integer | Rational | _RealMpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> _DoubleSage: ...
    # ComplexNumber / CDF Number
    @overload
    def __call__[C: _ComplexMpfrDoubleSage](
        self, nu: C, x: _py_number | Integer | Rational | _MpfrDoubleSage, /, *,
        hold: bool = False
    ) -> C: ...
    # Expr / Inf / Balls / Intervals
    @overload
    def __call__(
        self, nu: _BallMpfiSage | _inf, 
        x: _py_number | Integer | Rational | FloatingSage | _inf
             | Expression_[SymbolicRing] | CommutativePolynomial, /, *,
        hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__[P: SymbolicRingABC](
        self, nu: Expression_[P], 
        x: _py_number | Integer | Rational | FloatingSage | _inf
             | Expression_[P] | CommutativePolynomial, /, *,
        hold: bool = False
    ) -> Expression_[P]: ...
    @overload
    def __call__[P: SymbolicRingABC](
        self, nu: _py_number | Integer | Rational | FloatingSage | _inf | CommutativePolynomial, 
        x: Expression_[P], /, *,
        hold: bool = False
    ) -> Expression_[P]: ...
    @overload
...
class Function_Bessel_I(BuiltinFunction):
    ...
    @overload
    def __call__(
        self, nu: int | Integer, x: complex, /, *, hold: bool = False
    ) -> complex: ...
    # float
    @overload
    def __call__(
...
class Function_Bessel_K(BuiltinFunction):
    ...
    def __call__(
        self, 
        nu: int | Integer | Rational, 
        x: int | Integer | Rational | _BallMpfiSage | MinusInfinity | UnsignedInfinity, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, nu: int | Integer, x: PlusInfinity, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, nu: int | Integer | Rational, x: float, /, *, hold: bool = False
    ...
    @overload
    def __call__(
        self, nu: int | float | Integer | Rational, x: RealNumber, /, *, hold: bool = False
    ) -> _MpfrSage: ...
    @overload
    def __call__(
        self, nu: int | float | Integer | Rational, x: RealDoubleElement, 
    ...
    @overload
    def __call__(
        self, nu: Rational, x: PlusInfinity, /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, nu: Rational, x: PlusInfinity, /, 
    ) -> Expression_[SymbolicRing] | Integer: ...
    # complex
    @overload
    def __call__(
...
type _Bessel = Function_Bessel_J | Function_Bessel_Y | Function_Bessel_I | Function_Bessel_K

bessel_K: Function_Bessel_K
bessel_type_dict: dict[str, _Bessel] = {
    "I": bessel_I,
    "J": bessel_J,
    "K": bessel_K,
    "Y": bessel_Y,
...
class _Bessel_Y_int(Protocol):
    @overload
    def __call__(
        self, x: int | Integer | Rational | _BallMpfiSage | _inf, /
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(self, x: float, /) -> complex | float: ...
    @overload
    def __call__(
        self, x: CommutativePolynomial, /
    ) -> Expression_[SymbolicRing] | FloatingSage: ...
    @overload
    def __call__[T: complex | RealNumber | _ComplexMpfrDoubleSage](self, x: T, /) -> T: ...
    @overload
    def __call__(self, x: RealDoubleElement, /) -> _DoubleSage: ...
    @overload
    def __call__[P: SymbolicRingABC](self, x: Expression_[P], /) -> Expression_[P]: ...
class _Bessel_K_int(Protocol):
    @overload
    def __call__(
        self, x: int | Integer | Rational | _BallMpfiSage | _inf, /
    ) -> Expression_[SymbolicRing]: ...
    ...
    @overload
    def __call__[T: complex | _ComplexMpfrDoubleSage](self, x: T, /) -> T: ...
    @overload
    def __call__(self, x: RealNumber, /) -> _MpfrSage: ...
    @overload
    def __call__(self, x: RealDoubleElement, /) -> _DoubleSage: ...
    @overload
    def __call__[P: SymbolicRingABC](self, x: Expression_[P], /) -> Expression_[P]: ...
class _Bessel_I_int(Protocol):
    @overload
    def __call__[I: int | Integer](
        self, x: I, /
    ) -> I | Expression_[SymbolicRing]: ...
    @overload
    def __call__(self, x: float, /) -> float | complex: ...
    @overload
    def __call__[T: complex | _ComplexMpfrDoubleSage](self, x: T, /) -> T: ...
    @overload
    def __call__(
    ...
    @overload
    def __call__(
        self, x: _BallMpfiSage | _inf, /
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__[P: SymbolicRingABC](self, x: Expression_[P], /) -> Expression_[P]: ...
class _Bessel_I_Integer(Protocol):
    @overload
    def __call__(
        self, x: int | Integer | Rational, /
    ) -> Integer | Expression_[SymbolicRing]: ...
    @overload
    def __call__(self, x: float, /) -> float | complex: ...
    @overload
    ...
    @overload
    def __call__[P: SymbolicRingABC](self, x: Expression_[P], /) -> Expression_[P]: ...
class _Bessel_J_int(Protocol):
    @overload
    def __call__[I: int | Integer](
        self, x: I, /
    ) -> I | Expression_[SymbolicRing]: ...
    @overload
    def __call__[T: float | complex | _MpfrDoubleSage](self, x: T, /) -> T: ...
    @overload
    def __call__(
        self, x: Rational, /
    ) -> Integer | Expression_[SymbolicRing]: ...
    ...
    @overload
    def __call__[P: SymbolicRingABC](self, x: Expression_[P], /) -> Expression_[P]: ...
class _Bessel_J_Integer(Protocol):
    @overload
    def __call__(
        self, x: int | Integer | Rational, /
    ) -> Integer | Expression_[SymbolicRing]: ...
...
# as the docstring, order is an integer, though the implementation does not check that
# hence I would only type order: int | Integer cases
@overload
def Bessel(order: int | Integer, type: Literal["Y"], /) -> _Bessel_Y_int: ...
@overload
def Bessel(order: int | Integer, /, *, typ: Literal["Y"]) -> _Bessel_Y_int: ...
@overload
def Bessel(order: int | Integer, type: Literal["K"], /) -> _Bessel_K_int: ...
@overload
def Bessel(order: int | Integer, /, *, typ: Literal["K"]) -> _Bessel_K_int: ...
@overload
def Bessel(order: int, type: Literal["I"], /) -> _Bessel_I_int: ...
@overload
def Bessel(order: int, /, *, typ: Literal["I"]) -> _Bessel_I_int: ...
@overload
def Bessel(order: Integer, type: Literal["I"], /) -> _Bessel_I_Integer: ...
@overload
def Bessel(order: Integer, /, *, typ: Literal["I"]) -> _Bessel_I_Integer: ...
@overload
def Bessel(order: int, type: Literal["J"], /) -> _Bessel_J_int: ...
@overload
def Bessel(order: int, /, *, typ: Literal["J"] = "J") -> _Bessel_J_int: ...
@overload
def Bessel(order: Integer, type: Literal["J"], /) -> _Bessel_J_Integer: ...
@overload
def Bessel(order: Integer, /, *, typ: Literal["J"] = "J") -> _Bessel_J_Integer: ...
@overload
def Bessel(*, typ: Literal["Y"]) -> Function_Bessel_Y: ...
@overload
def Bessel(*, typ: Literal["K"]) -> Function_Bessel_K: ...
@overload
def Bessel(*, typ: Literal["I"]) -> Function_Bessel_I: ...
@overload
def Bessel(*, typ: Literal["J"] = "J") -> Function_Bessel_J:
    """
...
class _Struve:
    ...
    @overload
    def __call__[I: int | Integer](
        self, a: int | Integer, x: I, /) -> I | Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, 
    ...
    @overload
    def __call__[T: float | complex | _MpfrDoubleSage](
        self, a: int | Integer, x: T, /, *, hold: bool = False) -> T: ...
    @overload
    def __call__(
        self, a: int | Integer, x: Rational, /
    ) -> Integer | Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, a: int | Integer | Rational, x: CommutativePolynomial, /
    ) -> Integer | Expression_[SymbolicRing] | FloatingSage: ...
    @overload
    def __call__(
        self, 
        a: _py_number | Integer | Rational | CommutativePolynomial | RealInexactSage | _ComplexMpfrDoubleSage | ComplexIntervalFieldElement, 
        x: _BallMpfiSage | _inf, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    # float / Rational
    ...
    def __call__(
        self, 
        a: float, 
        x: int | float | Integer | Rational,
        /, *, hold: bool = False
    ) -> complex | float: ...
    @overload
    def __call__(
        self, a: Rational, x: int | Integer | Rational, /
    ) -> Integer | Rational | Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, 
        a: Rational, 
    ...
    @overload
    def __call__[C: complex | _ComplexMpfrDoubleSage](
        self, 
        a: float | Rational | _RealMpfrDoubleSage, 
        x: C,
        /, *, hold: bool = False
    ) -> C: ...
    @overload
    def __call__(
        self, 
        a: float | _MpfrDoubleSage, 
        x: CommutativePolynomial,
        /, *, hold: bool = False
    ) -> CommutativePolynomial | Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, a: float | Rational, x: RealNumber, /, *, hold: bool = False
    ) -> _MpfrSage: ...
    @overload
    def __call__(
        self, a: float | Rational, x: RealDoubleElement, /, *, hold: bool = False
    ) -> _DoubleSage: ...
    # complex
    @overload
    def __call__(
        self, a: complex, x: _py_number | Integer | Rational | _RealMpfrDoubleSage,
        /, *, hold: bool = False
    ) -> complex: ...
    @overload
    def __call__(
        self, a: complex, x: CommutativePolynomial,
        /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
    ...
    def __call__(
        self, 
        a: CommutativePolynomial, 
        x: int | Integer | Rational | CommutativePolynomial,
        /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, a: CommutativePolynomial, x: Integer | Rational | CommutativePolynomial, /, 
    ) -> Expression_[SymbolicRing] | Integer | FloatingSage: ...
    @overload
    def __call__(
        self, a: CommutativePolynomial, x: float | complex, /, 
    ) -> CommutativePolynomial: ...
    @overload
    def __call__(
        self, a: CommutativePolynomial, x: float | complex, 
    ...
    @overload
    def __call__(
        self, a: CommutativePolynomial, x: _MpfrDoubleSage, 
        /, *, hold: bool = False 
    ) -> CommutativePolynomial | Expression_[SymbolicRing]: ...
    # RealNumber / RDF
    @overload
    def __call__(
        self, a: RealNumber, x: int | float | Integer | Rational | _RealMpfrDoubleSage, 
        /, *, hold: bool = False 
    ) -> _MpfrSage: ...
    @overload
    def __call__(
        self, a: RealDoubleElement, x: int | float | Integer | Rational | _RealMpfrDoubleSage, 
        /, *, hold: bool = False 
    ) -> _DoubleSage: ...
    # ComplexNumber / CDF
    @overload
    def __call__[C: _ComplexMpfrDoubleSage](
        self, a: C, x: _py_number | Integer | Rational | _MpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> C: ...
    # Balls / Mpfi
    @overload
    def __call__(
        self, a: _BallMpfiSage, x: _py_number | Integer | Rational | FloatingSage | CommutativePolynomial, 
        /, *, hold: Literal[True] 
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, 
        a: RealBall | RealIntervalFieldElement, 
        x: int | Integer | Rational | CommutativePolynomial, 
        /, 
    ) -> Expression_[SymbolicRing] | Integer: ...
    @overload
    ...
    def __call__(
        self, 
        a: ComplexIntervalFieldElement, 
        x: int | Integer | Rational | CommutativePolynomial | FloatingSage, 
        /, 
    ) -> Expression_[SymbolicRing]: ...
    # Inf
    @overload
    ...
    def __call__[P: SymbolicRingABC](
        self, 
        a: Expression_[P], 
        x: _py_number | Integer | Rational | Expression_[P] | CommutativePolynomial | FloatingSage | _inf, 
        /, *, hold: Literal[True]
    ) -> Expression_[P]: ...
    @overload
    def __call__[P: SymbolicRingABC](
        self, 
        a: Expression_[P], 
        x: int | Integer | Rational | Expression_[P] | CommutativePolynomial | FloatingSage | _inf, 
        /, 
    ) -> Expression_[P]: ...
    @overload
    def __call__(
        self, a: Expression_, x: Expression_, /, hold: bool = False
    ) -> Expression_: ...
    @overload
    def __call__[P: SymbolicRingABC](
        self, 
        a: int | float | Integer | Rational | CommutativePolynomial
         | RealInexactSage | _ComplexMpfrDoubleSage
         | ComplexIntervalFieldElement | PlusInfinity | MinusInfinity, 
        x: Expression_[P], /, *, hold: bool = False
    ) -> Expression_[P]: ...
    @overload
    def __call__[P: SymbolicRingABC](
        self, 
        a: complex | ComplexBall | UnsignedInfinity,
        x: Expression_[P], /, *, hold: Literal[True]
    ) -> Expression_[P]: ...

class Function_Struve_H(_Struve, BuiltinFunction):
    """
...
class Function_Struve_L(_Struve, BuiltinFunction):
    """
...
class _Hankel:
    ...
    @overload
    def __call__(
        self, nu: int | Integer | Rational, z: int | Integer | Rational, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__( # put here to avoid Python's stupid int <: float <: complex
        self, nu: float, z: int | Integer | Rational, 
        /, *, hold: bool = False
    ) -> float | complex: ...
    @overload
    def __call__( # put here to avoid Python's stupid int <: float <: complex
        self, nu: complex, x: int | Integer | Rational | _RealMpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> complex: ...
    @overload
    def __call__(
        self, nu: _py_number | Integer | Rational, 
        z: float | complex, /, *, hold: bool = False) -> complex: ...
    @overload
    def __call__(
        self, nu: int | Integer | Rational, z: CommutativePolynomial, 
        /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
    ...
    def __call__[C: _ComplexMpfrDoubleSage](
        self, 
        nu: _py_number | Integer | Rational | _RealMpfrDoubleSage, 
        x: C,
        /, *, hold: bool = False
    ) -> C: ...
    @overload
    def __call__(
        self, 
        nu: _py_number | Integer | Rational, z: _BallMpfiSage | _inf, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    # float
    # (int, float | Integer | Rational) put above
    @overload
    def __call__(
        self, nu: float, x: CommutativePolynomial, 
        /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
    ...
    @overload
    def __call__(
        self, nu: complex, x: CommutativePolynomial, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | CommutativePolynomial | complex: ...
    # Polynomial
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: int | Integer | Rational | CommutativePolynomial, 
        /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: int | Integer | Rational | CommutativePolynomial, /
    ) -> Expression_[SymbolicRing] | ComplexInexactSage: ...
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: float, /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: float, /
    ) -> Expression_[SymbolicRing] | ComplexInexactSage | complex: ...
    @overload
    def __call__(
        self, 
        nu: CommutativePolynomial, 
        x: complex | RealNumber | _ComplexMpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
        self, nu: CommutativePolynomial, x: RealDoubleElement, 
        /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
    ...
    @overload
    def __call__(
        self, nu: RealNumber, x: int | Integer | Rational, 
        /, *, hold: bool = False
    ) -> _MpfrSage: ...
    @overload
    def __call__(
        self, nu: RealDoubleElement, x: int | Integer | Rational, 
        /, *, hold: bool = False
    ) -> _DoubleSage: ...
    @overload
    def __call__(
        self, nu: RealNumber, x: float, 
        /, *, hold: bool = False
    ) -> ComplexNumber: ...
    @overload
    def __call__(
        self, nu: RealDoubleElement, x: float, 
        /, *, hold: bool = False
    ) -> ComplexDoubleElement: ...
    @overload
    def __call__(
        self, nu: RealNumber | RealDoubleElement, x: complex, 
        /, *, hold: bool = False
    ) -> complex: ...
    @overload
    def __call__(
        self, nu: RealNumber | _ComplexMpfrDoubleSage, x: CommutativePolynomial, 
        /, *, hold: bool = False
    ) -> CommutativePolynomial | Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, nu: RealDoubleElement, x: CommutativePolynomial, 
        /, *, hold: Literal[True]
    ) -> CommutativePolynomial | Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, nu: RealDoubleElement, x: CommutativePolynomial, /, 
    ) -> CommutativePolynomial | Expression_[SymbolicRing] | ComplexDoubleElement: ...
    @overload
    def __call__(self, nu: RealNumber, x: _RealMpfrDoubleSage, /, *, hold: bool = False) -> ComplexNumber: ...
    @overload
    def __call__(self, nu: RealDoubleElement, x: _RealMpfrDoubleSage, /, *, hold: bool = False) -> ComplexDoubleElement: ...
    # ComplexNumber / CDF
    @overload
    def __call__[C: _ComplexMpfrDoubleSage](
        self, 
        nu: C, 
        x: _py_number | Integer | Rational | _MpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> C: ...
    # Balls / Mpfi / Inf
    @overload
    ...
    def __call__[P: SymbolicRingABC](
        self, 
        nu: Expression_[P], 
        x: _py_number | Integer | Rational | CommutativePolynomial | FloatingSage | _inf | Expression_[P], 
        /, *, hold: bool = False
    ) -> Expression_[P]: ...
    @overload
    def __call__[P: SymbolicRingABC](
    ...
    @overload
    def __call__(
        self, nu: Expression_, x: Expression_, 
        /, *, hold: bool = False
    ) -> Expression_: ...

class Function_Hankel1(_Hankel, BuiltinFunction):
    """
...
class Function_Hankel2(_Hankel, BuiltinFunction):
    """
...
class _SphericalBessel:
    # int / Integer
    @overload
    def __call__(
        self, 
        n: int | Integer | Rational, 
        z: int | Integer | Rational, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__[T: float | complex | _MpfrDoubleSage](
        self, n: int | Integer, z: T, 
        /, *, hold: bool = False
    ) -> T: ...
    @overload
    def __call__(
        self, 
        n: int | Integer | Rational | CommutativePolynomial, 
    ...
    def __call__(
        self, 
        n: _py_number | Integer | Rational | CommutativePolynomial | FloatingSage | _inf, 
        z: _BallMpfiSage | _inf
    ) -> Expression_[SymbolicRing]: ...
    # float
    @overload
    def __call__(
        self, n: float, z: int | Integer | Rational, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | complex | float: ...
    @overload
    def __call__(
        self, n: float | Rational, z: float, /, *, hold: bool = False
    ) -> complex | float: ...
    @overload
    def __call__(
        self, n: float | Rational, z: complex, /, *, hold: bool = False) -> complex: ...
    @overload
    def __call__[T: _ComplexMpfrDoubleSage](
        self, n: float | complex | Rational | _RealMpfrDoubleSage, z: T, 
        /, *, hold: bool = False
    ) -> T: ...
    @overload
    def __call__(
        self, n: float | complex | _MpfrDoubleSage, z: CommutativePolynomial, 
        /, *, hold: bool = False
    ) -> CommutativePolynomial | Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, n: float | Rational, z: RealNumber, /, *, hold: bool = False
    ) -> _MpfrSage: ...
    @overload
    def __call__(
        self, n: float | Rational, z: RealDoubleElement, /, *, hold: bool = False
    ) -> _DoubleSage: ...
    # complex
    @overload
    def __call__(
        self, n: complex, z: int | Integer | Rational, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | complex: ...
    @overload
    def __call__(
        self, n: complex, z: float | complex | _RealMpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> complex: ...
    # Polynomials
    @overload
    def __call__(
        self, n: CommutativePolynomial, z: int | Integer | Rational, /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing]: ...
    @overload
    def __call__(
        self, n: CommutativePolynomial, z: int | Integer | Rational, /
    ) -> Expression_[SymbolicRing] | FloatingSage: ...
    @overload
    def __call__(
        self, n: CommutativePolynomial, z: float | complex | _MpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    # RR / RDF
    @overload
    def __call__(
        self, n: RealNumber, z: int | Integer | Rational, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | _MpfrSage: ...
    @overload
    def __call__(
        self, n: RealDoubleElement, z: int | Integer | Rational, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | _DoubleSage: ...
    @overload
    def __call__(
        self, n: RealNumber, z: float | _RealMpfrDoubleSage, 
        /, *, hold: bool = False
    ) ->  _MpfrSage: ...
    @overload
    def __call__(
        self, n: RealDoubleElement, z: float | _RealMpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> _DoubleSage: ...
    @overload
    def __call__(
        self, n: RealNumber | RealDoubleElement, z: complex, /, *, hold: bool = False) -> complex: ...
    # CC / CDF
    @overload
    def __call__[C: _ComplexMpfrDoubleSage](
        self, n: C, z: int | Integer | Rational, /, *, hold: bool = False
    ) -> C | Expression_[SymbolicRing]: ...
    @overload
    def __call__[C: _ComplexMpfrDoubleSage](
        self, n: C, z: float | complex | _MpfrDoubleSage, /, *, hold: bool = False
    ) -> C: ...
    # Balls / Mpfi / Inf
    @overload
    def __call__(
        self, 
        n: _BallMpfiSage | _inf, 
        z: _py_number | Integer | Rational | CommutativePolynomial | FloatingSage | _inf, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing]: ...
    # Expressions
    @overload
    def __call__[P: SymbolicRingABC](
        self, 
        n: Expression_[P], 
        z: _py_number | Integer | Rational | CommutativePolynomial | FloatingSage | _inf | Expression_[P], 
        /, *, hold: bool = False
    ) -> Expression_[P]: ...
    @overload
    def __call__[P: SymbolicRingABC](
...
class SphericalBesselJ(_SphericalBessel, BuiltinFunction):
    """
...
class SphericalBesselY(_SphericalBessel, BuiltinFunction):
    """
...
class SphericalHankel1(BuiltinFunction):
    ...
    def __call__[T: _ComplexMpfrDoubleSage](
        self, 
        n: _py_number | Integer | Rational | _RealMpfrDoubleSage, 
        z: T, 
        /, *, hold: bool = False
    ) -> T: ...
    @overload
    ...
    # write (T, int) first to avoid stupid complex :> float :> int
    @overload
    def __call__(
        self, n: float | complex, z: int | Integer | Rational, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | complex: ...
    @overload
    def __call__(
    ...
    @overload
    def __call__(
        self, n: _MpfrSage, z: int | Integer | Rational, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | ComplexNumber: ...
    @overload
    def __call__(
        self, n: _DoubleSage, z: int | Integer, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | ComplexDoubleElement: ...
    # float
    @overload
    def __call__(
        self, n: float | complex, z: float | complex, 
        /, *, hold: bool = False
    ) -> complex: ...
    @overload
    def __call__(
    ...
    # write (T, float) first to avoid stupid complex :> float
    @overload
    def __call__(
        self, n: CommutativePolynomial, z: float, /, *, hold: Literal[True]
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
        self, n: CommutativePolynomial, z: float, /
    ) -> Expression_[SymbolicRing] | CommutativePolynomial | complex: ...
    @overload
    def __call__(
        self, n: _MpfrSage, z: float, /, *, hold: bool = False
    ) -> ComplexNumber: ...
    @overload
    def __call__(
        self, n: _DoubleSage, z: float, /, *, hold: bool = False
    ) -> ComplexDoubleElement: ...
    # complex
    @overload
    def __call__(
        self, n: complex | _MpfrDoubleSage, z: CommutativePolynomial, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    @overload
    def __call__(
        self, n: complex, z: _RealMpfrDoubleSage, /, *, hold: bool = False
    ) -> complex: ...
    # Polynomial
    @overload
    def __call__(
        self, n: CommutativePolynomial, z: complex | _MpfrDoubleSage, 
        /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | CommutativePolynomial: ...
    # RR / RDF
    @overload
    def __call__(
        self, n: _RealMpfrDoubleSage, z: complex, /, *, hold: bool = False
    ) -> complex: ...
    @overload
    def __call__(
        self, n: RealDoubleElement, z: Rational, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | _DoubleSage: ...
    @overload
    def __call__[R: _RealMpfrDoubleSage](
        self, n: R, z: _RealMpfrDoubleSage, /, *, hold: bool = False) -> R: ...
    # CC / CDF
    @overload
    def __call__[C: _ComplexMpfrDoubleSage](
        self, n: C, z: complex | _MpfrDoubleSage, /, *, hold: bool = False) -> C: ...
    # Balls / Mpfi / Inf
    @overload
    def __call__(
        self, 
...
class SphericalHankel2(BuiltinFunction):
    ...
    @overload
    def __call__(
        self, n: _DoubleSage, z: int | Integer | Rational, /, *, hold: bool = False
    ) -> Expression_[SymbolicRing] | ComplexDoubleElement: ...
    # float
    @overload
    def __call__(
