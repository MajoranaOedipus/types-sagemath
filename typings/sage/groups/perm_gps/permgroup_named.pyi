...
from sage.arith.misc import factor as factor, valuation as valuation
...
from sage.groups.perm_gps.permgroup_element import SymmetricGroupElement as SymmetricGroupElement
from sage.libs.gap.libgap import libgap as libgap
from sage.misc.cachefunc import cached_method as cached_method, weak_cached_function as weak_cached_function
...
class PGL(PermutationGroup_plg):
    def __init__(self, n, q, name: str = 'a') -> None:
        """
...
class SuzukiGroup(PermutationGroup_unique):
    def __init__(self, q, name: str = 'a') -> None:
        """
