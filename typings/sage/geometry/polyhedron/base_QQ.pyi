...
class Polyhedron_QQ(Polyhedron_base):
    ...
    """
    def integral_points_count(self, verbose: bool = False, use_Hrepresentation: bool = False, explicit_enumeration_threshold: int = 1000, preprocess: bool = True, **kwds):
        '''
    ...
    def ehrhart_polynomial(self, engine=None, variable: str = 't', verbose: bool = False, dual=None, irrational_primal=None, irrational_all_primal=None, maxdet=None, no_decomposition=None, compute_vertex_cones=None, smith_form=None, dualization=None, triangulation=None, triangulation_max_height=None, **kwds):
        ...
        *Ehrhart polynomial* of `P`. For more information see the
        ...
        The cache of the Ehrhart polynomial is being pickled::
            ...
            1
        """
    def ehrhart_quasipolynomial(self, variable: str = 't', engine=None, verbose: bool = False, dual=None, irrational_primal=None, irrational_all_primal=None, maxdet=None, no_decomposition=None, compute_vertex_cones=None, smith_form=None, dualization=None, triangulation=None, triangulation_max_height=None, **kwds):
        """
