from sage.dynamics.finite_dynamical_system import DiscreteDynamicalSystem as DiscreteDynamicalSystem, FiniteDynamicalSystem as FiniteDynamicalSystem, InvertibleDiscreteDynamicalSystem as InvertibleDiscreteDynamicalSystem, InvertibleFiniteDynamicalSystem as InvertibleFiniteDynamicalSystem

def permutation(pi, invertible: bool = True):
    """
...
def bitstring_rotation(n, ones=None):
    ...
    EXAMPLES::
        ...
        True
    """
def striker_sweep(E, predicate, elements, lazy: bool = False):
    '''
    Return the invertible finite discrete dynamical system
