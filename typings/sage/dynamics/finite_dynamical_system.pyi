...
class DiscreteDynamicalSystem(SageObject, metaclass=ClasscallMetaclass):
    ...
    * its homomesies (i.e., maps `h : X \\to A` to a
    ...
    """
    @staticmethod
    def __classcall_private__(cls, X, phi, cache_orbits: bool = False, create_tuple: bool = False, inverse=None, is_finite=None):
        """
        ...
        EXAMPLES::
            ...
            <class 'sage.dynamics.finite_dynamical_system.FiniteDynamicalSystem'>
        """
    def __init__(self, X, phi, cache_orbits: bool = False, create_tuple: bool = False) -> None:
        """
        Initialize ``self``.
    ...
    def __getitem__(self, i):
        ...
        EXAMPLES::
            ...
            7
        """
    def orbit(self, x, preperiod: bool = False):
        '''
        ...
        EXAMPLES::
            ...
            [0]
        '''
    def is_homomesic(self, h, average=None, find_average: bool = False, elements=None):
        """
...
class InvertibleDiscreteDynamicalSystem(DiscreteDynamicalSystem):
    ...
    The necessity of ``create_tuple=True``::
        ...
        (0, 1, 2, 3, 4)
    """
    def __init__(self, X, phi, inverse=None, cache_orbits: bool = False, create_tuple: bool = False) -> None:
        """
        Initialize ``self``.
