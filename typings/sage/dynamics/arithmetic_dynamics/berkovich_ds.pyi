...
from sage.schemes.berkovich.berkovich_space import Berkovich_Cp as Berkovich_Cp, Berkovich_Cp_Affine as Berkovich_Cp_Affine, Berkovich_Cp_Projective as Berkovich_Cp_Projective, Berkovich_Element_Cp_Affine as Berkovich_Element_Cp_Affine
...
class DynamicalSystem_Berkovich_projective(DynamicalSystem_Berkovich):
    ...
    def normalize_coordinates(self) -> None:
        ...
        """
    def conjugate(self, M, adjugate: bool = False, new_ideal=None):
        """
    ...
    def dehomogenize(self, n):
        ...
        """
    def __call__(self, x, type_3_pole_check: bool = True):
        """
