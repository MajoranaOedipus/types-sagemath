...
class PowComputer_(sage.rings.padics.pow_computer_flint.PowComputer_flint_unram):
    ...
    File: /build/sagemath/src/sage/src/sage/rings/padics/qadic_flint_FM.pyx (starting at line 5)
    ...
    def __init__(self, Integerprime, longcache_limit, longprec_cap, longram_prec_cap, boolin_field, poly=...) -> Any:
        """File: /build/sagemath/src/sage/src/sage/rings/padics/qadic_flint_FM.pyx (starting at line 9)
...
class qAdicFixedModElement(FMElement):
    ...
    def matrix_mod_pn(self) -> Any:
        """qAdicFixedModElement.matrix_mod_pn(self)

        File: /build/sagemath/src/sage/src/sage/rings/padics/qadic_flint_FM.pyx (starting at line 29)
