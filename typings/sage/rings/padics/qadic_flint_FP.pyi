...
class PowComputer_(sage.rings.padics.pow_computer_flint.PowComputer_flint_unram):
    ...
    File: /build/sagemath/src/sage/src/sage/rings/padics/qadic_flint_FP.pyx (starting at line 7)
    ...
    def __init__(self, Integerprime, longcache_limit, longprec_cap, longram_prec_cap, boolin_field, poly=...) -> Any:
        """File: /build/sagemath/src/sage/src/sage/rings/padics/qadic_flint_FP.pyx (starting at line 11)
...
class qAdicFloatingPointElement(FPElement):
    ...
    def matrix_mod_pn(self) -> Any:
        """qAdicFloatingPointElement.matrix_mod_pn(self)

        File: /build/sagemath/src/sage/src/sage/rings/padics/qadic_flint_FP.pyx (starting at line 31)
    ...
    def trace(self, *args, **kwargs):
        ...
        Check that :issue:`31845` is fixed::
            ...
            O(2^20)"""
    def __hash__(self) -> Any:
        """qAdicFloatingPointElement.__hash__(self)

        File: /build/sagemath/src/sage/src/sage/rings/padics/qadic_flint_FP.pyx (starting at line 147)
