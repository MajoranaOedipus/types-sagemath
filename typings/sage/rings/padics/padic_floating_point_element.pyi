...
class PowComputer_(sage.rings.padics.pow_computer.PowComputer_base):
    ...
    File: /build/sagemath/src/sage/src/sage/rings/padics/padic_floating_point_element.pyx (starting at line 33)
    ...
    def __init__(self, Integerprime, longcache_limit, longprec_cap, longram_prec_cap, boolin_field) -> Any:
        """File: /build/sagemath/src/sage/src/sage/rings/padics/padic_floating_point_element.pyx (starting at line 37)
...
class pAdicFloatingPointElement(FPElement):
    """File: /build/sagemath/src/sage/src/sage/rings/padics/padic_floating_point_element.pyx (starting at line 52)
    ...
    def __init__(cls, *args, **kwargs) -> None:
        """Create and return a new object.  See help(type) for accurate signature."""
    def lift(self) -> Any:
        """pAdicFloatingPointElement.lift(self)

        File: /build/sagemath/src/sage/src/sage/rings/padics/padic_floating_point_element.pyx (starting at line 140)
    ...
    def residue(self, absprec=..., field=..., check_prec=...) -> Any:
        """pAdicFloatingPointElement.residue(self, absprec=1, field=None, check_prec=False)

        File: /build/sagemath/src/sage/src/sage/rings/padics/padic_floating_point_element.pyx (starting at line 241)
    ...
    def __pari__(self) -> Any:
        """pAdicFloatingPointElement.__pari__(self)

        File: /build/sagemath/src/sage/src/sage/rings/padics/padic_floating_point_element.pyx (starting at line 193)
