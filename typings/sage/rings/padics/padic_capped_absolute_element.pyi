...
make_pAdicCappedAbsoluteElement: _cython_3_2_1.cython_function_or_method
...
class PowComputer_(sage.rings.padics.pow_computer.PowComputer_base):
    ...
    File: /build/sagemath/src/sage/src/sage/rings/padics/padic_capped_absolute_element.pyx (starting at line 33)
    ...
    def __init__(self, Integerprime, longcache_limit, longprec_cap, longram_prec_cap, boolin_field) -> Any:
        """File: /build/sagemath/src/sage/src/sage/rings/padics/padic_capped_absolute_element.pyx (starting at line 37)
...
class pAdicCappedAbsoluteElement(CAElement):
    """File: /build/sagemath/src/sage/src/sage/rings/padics/padic_capped_absolute_element.pyx (starting at line 52)
    ...
    @overload
    def lift(self) -> Any:
        """pAdicCappedAbsoluteElement.lift(self)

        File: /build/sagemath/src/sage/src/sage/rings/padics/padic_capped_absolute_element.pyx (starting at line 88)
    ...
    def multiplicative_order(self) -> Any:
        """pAdicCappedAbsoluteElement.multiplicative_order(self)

        File: /build/sagemath/src/sage/src/sage/rings/padics/padic_capped_absolute_element.pyx (starting at line 258)
    ...
    def residue(self, absprec=..., field=..., check_prec=...) -> Any:
        """pAdicCappedAbsoluteElement.residue(self, absprec=1, field=None, check_prec=True)

        File: /build/sagemath/src/sage/src/sage/rings/padics/padic_capped_absolute_element.pyx (starting at line 170)
    ...
    def __pari__(self) -> Any:
        """pAdicCappedAbsoluteElement.__pari__(self)

        File: /build/sagemath/src/sage/src/sage/rings/padics/padic_capped_absolute_element.pyx (starting at line 113)
