...
class IntegerRing_class(PrincipalIdealDomain):
    ...
    @overload
    def __eq__(self, other: IntegerRing_class) -> Literal[True]: ...
    @overload
    def __eq__(self, other: object) -> bool: ...
    @overload
    def __ge__(self, other: IntegerRing_class) -> Literal[True]: ...
    @overload
    ...
    def __iter__(self) -> Iterator[Integer]:
        ...
        EXAMPLES::
            ...
            -2"""
    @overload
    def __le__(self, other: IntegerRing_class | RationalField) -> Literal[True]: ...
    @overload
    def __le__(self, other: object) -> bool: ...
    @overload
    def __lt__(self, other: RationalField) -> Literal[True]: ...
    @overload
    def __lt__(self, other: object) -> bool: ...
    @overload
    def __ne__(self, other: IntegerRing_class) -> Literal[False]: ...
    @overload
