...
@cached_function
def check_kwds(**kwds: dict[KnownKeywords, Any]) -> list[KnownKeywords]:
    r"""
...
@cached_function
def khoca_interface(ring: Ring, **kwds: dict[KnownKeywords, Any]) -> InteractiveCalculator:
    r"""
...
@cached_function
def khoca_raw_data(link: Link, ring: Ring, red_typ=True, **kwds: dict[KnownKeywords, Any]):
    r"""
