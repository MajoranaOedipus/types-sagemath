...
from sage.features.jmol import JmolDataJar as JmolDataJar
...
class JmolData(SageObject):
    ...
    def is_jmol_available(self):
        ...
        Check that it returns a boolean::
            ...
            <... 'bool'>
        """
    def export_image(self, targetfile, datafile, datafile_cmd: str = 'script', image_type: str = 'PNG', figsize: int = 5, **kwds) -> None:
        '''
