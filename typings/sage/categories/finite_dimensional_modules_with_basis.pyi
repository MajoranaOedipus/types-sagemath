from sage.categories.category_with_axiom import CategoryWithAxiom as CategoryWithAxiom, CategoryWithAxiom_over_base_ring as CategoryWithAxiom_over_base_ring
...
class FiniteDimensionalModulesWithBasis(CategoryWithAxiom_over_base_ring):
    ...
    class ParentMethods:
        def gens(self) -> tuple:
            ...
            EXAMPLES::
                ...
                (B['a'], B['b'], B['c'])
            """
        def annihilator(self, S, action=..., side: str = 'right', category=None):
            '''
            ...
            '''
        def annihilator_basis(self, S, action=..., side: str = 'right'):
            """
        ...
        def echelon_form(self, elements, row_reduced: bool = False, order=None):
            ...
            We convert the input elements to ``self``::
                ...
                [1, x]
            """
        def invariant_module(self, S, action=..., action_on_basis=None, side: str = 'left', **kwargs):
            """
            ...
            construct the `H`-invariant module of the group algebra `\\QQ[G]`::
                ...
                True
            """
        def twisted_invariant_module(self, G, chi, action=..., action_on_basis=None, side: str = 'left', **kwargs):
            """
    ...
    class MorphismMethods:
        def matrix(self, base_ring=None, side: str = 'left'):
            '''
