    ...
    class ParentMethods:
        ...
        def lower_covers(self, x) -> None:
            ...
            EXAMPLES::
                ...
                [3, 5]
            '''
        def order_ideal(self, elements) -> None:
            """
            ...
            """
        def order_filter(self, elements) -> None:
            """
        ...
        def is_order_filter(self, o):
            ...
            EXAMPLES::
                ...
                True
            '''
        def is_chain_of_poset(self, o, ordered: bool = False):
            '''
