...
from sage.categories.tensor import TensorProductFunctor as TensorProductFunctor, TensorProductsCategory as TensorProductsCategory, tensor as tensor
...
class Modules(Category_module):
    ...
    """
    @staticmethod
    def __classcall_private__(cls, base_ring, dispatch: bool = True):
        """
    ...
    class ParentMethods:
        ...
        def module_morphism(self, *, function, category=None, codomain, **keywords):
            ...
            """
        def quotient(self, submodule, check: bool = True, **kwds):
            """
