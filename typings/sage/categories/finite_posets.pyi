    ...
    class ParentMethods:
        ...
        def is_poset_morphism(self, f, codomain):
            ...
            Base cases::
                ...
                True
            '''
        def order_ideal_generators(self, ideal, direction: str = 'down'):
            '''
        ...
        def order_filter_generators(self, filter):
            ...
            '''
        def order_ideal_complement_generators(self, antichain, direction: str = 'up'):
            """
        ...
        def rowmotion(self, order_ideal):
            ...
            EXAMPLES::
                ...
                {}
            """
        def birational_free_labelling(self, linear_extension=None, prefix: str = 'x', base_field=None, reduced: bool = False, addvars=None, labels=None, min_label=None, max_label=None):
            '''
        ...
        def birational_rowmotion(self, labelling):
            ...
            Facade set to false works::
                ...
                a*b/x3
            """
        def panyushev_orbits(self, element_constructor=...):
            """
            ...
            EXAMPLES::
                ...
                [[set()]]
            """
        def rowmotion_orbits(self, element_constructor=...):
            """
        ...
        def rowmotion_orbits_plots(self):
            ...
            """
        def toggling_orbits(self, vs, element_constructor=...):
            """
        ...
        def toggling_orbits_plots(self, vs):
            ...
            EXAMPLES::
                ...
                Graphics Array of size 1 x 1
            """
        def panyushev_orbit_iter(self, antichain, element_constructor=..., stop: bool = True, check: bool = True) -> Generator[Incomplete]:
            """
            ...
            EXAMPLES::
                ...
                {3}
            """
        def rowmotion_orbit_iter(self, oideal, element_constructor=..., stop: bool = True, check: bool = True) -> Generator[Incomplete]:
            """
            ...
            """
        def toggling_orbit_iter(self, vs, oideal, element_constructor=..., stop: bool = True, check: bool = True) -> Generator[Incomplete]:
            """
            ...
            EXAMPLES::
                ...
                {1}
            """
        def order_ideals_lattice(self, as_ideals: bool = True, facade=None):
            """
