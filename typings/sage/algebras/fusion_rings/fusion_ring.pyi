...
from sage.algebras.fusion_rings.fast_parallel_fusion_ring_braid_repn import executor as executor
from sage.combinat.q_analogues import q_int as q_int
...
class FusionRing(WeylCharacterRing):
    ...
    *total quantum order*. They are  computed by :meth:`global_q_dimension`
    ...
    '''
    @staticmethod
    def __classcall__(cls, ct, k, base_ring=..., prefix=None, style: str = 'coroots', conjugate: bool = False, cyclotomic_order=None, fusion_labels=None, inject_variables: bool = False):
        """
        ...
        """
    def check_braid_representation(self, max_strands: int = 6, anyon=None):
        '''
        ...
        EXAMPLES::
            ...
            True
        '''
    def fusion_labels(self, labels=None, inject_variables: bool = False) -> None:
        '''
    ...
    def Nk_ij(self, elt_i, elt_j, elt_k):
        ...
        '''
    @cached_method
    def s_ij(self, elt_i, elt_j, base_coercion: bool = True):
        '''
        ...
        '''
    def s_ijconj(self, elt_i, elt_j, base_coercion: bool = True):
        '''
    ...
    def total_q_order(self, base_coercion: bool = True):
        ...
        EXAMPLES::
            ...
            True
        '''
    def D_plus(self, base_coercion: bool = True):
        '''
        ...
        EXAMPLES::
            ...
            True
        '''
    def D_minus(self, base_coercion: bool = True):
        '''
    ...
    def get_fmatrix(self, *args, **kwargs):
        ...
        '''
    def get_braid_generators(self, fusing_anyon, total_charge_anyon, n_strands, checkpoint: bool = False, save_results: str = '', warm_start: str = '', use_mp: bool = True, verbose: bool = True):
        '''
