...
class Expression[P: SymbolicRingABC](sage.structure.element.Expression[P]):
    ...
    type _AddableWithExpr = int | float | complex | NumPyNumber | Integer | Rational | CommutativePolynomial | FloatingSage | Expression[P]
    @overload
    def __add__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
    def __add__(self, other: Expression) -> Expression: ...
    def __radd__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
    def __sub__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
    def __sub__(self, other: Expression) -> Expression: ...
    def __rsub__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
    def __mul__(self, other: _AddableWithExpr | mpz) -> Expression[P]: ...
    @overload
    def __mul__(self, other: Expression) -> Expression: ...
    def __rmul__(self, other: _AddableWithExpr | mpz) -> Expression[P]: ...
    @overload
    def __truediv__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
    def __truediv__(self, other: Expression) -> Expression: ...
    def __rtruediv__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
    def __pow__(
        self, 
    ...
    @overload
    def __pow__(
        self, other: Expression, modulus: None = None, /) -> Expression: ...
    def __rpow__(
        self,
    ...
    @overload
    def __eq__(self, other: _AddableWithExpr) -> Expression[P]: ... # pyright: ignore[reportOverlappingOverload]
    @overload
    def __eq__(self, other: Expression) -> Expression: ...
    @overload
    def __eq__(self, other: object) -> bool: ...
    @overload
    def __ne__(self, other: _AddableWithExpr) -> Expression[P]: ... # pyright: ignore[reportOverlappingOverload]
    @overload
    def __ne__(self, other: Expression) -> Expression: ...
    @overload
    def __ne__(self, other: object) -> bool: ...
    @overload
    def __lt__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
    def __lt__(self, other: Expression) -> Expression: ...
    @overload
    def __le__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
    def __le__(self, other: Expression) -> Expression: ...
    @overload
    def __gt__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
    def __gt__(self, other: Expression) -> Expression: ...
    @overload
    def __ge__(self, other: _AddableWithExpr) -> Expression[P]: ...
    @overload
