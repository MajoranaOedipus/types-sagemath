from sage.symbolic.function import SymbolicFunction as SymbolicFunction, sfunctions_funcs as sfunctions_funcs, unpickle_wrapper as unpickle_wrapper

def function_factory(name, nargs: int = 0, latex_name=None, conversions=None, evalf_params_first: bool = True, eval_func=None, evalf_func=None, conjugate_func=None, real_part_func=None, imag_part_func=None, derivative_func=None, tderivative_func=None, power_func=None, series_func=None, print_func=None, print_latex_func=None):
    """
