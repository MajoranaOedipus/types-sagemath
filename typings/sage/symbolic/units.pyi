...
type UnitType = str
type UnitName = str
type UnitValue = Rational | int | str

unitdict: dict[UnitType, dict[UnitName, UnitValue]] = {
'acceleration':
        {'gal': one / 100,
        'galileo': one / 100,
...
unit_to_type: dict[UnitValue, UnitType]
value_to_unit: dict[UnitType, dict[UnitValue, UnitName]]
...
unit_docs: dict[UnitType, dict[UnitName, str]] = {
'acceleration_docs':
...
unit_derivations: dict[UnitType, str] = {'acceleration': 'length/time^2',
                    'area': 'length^2',
