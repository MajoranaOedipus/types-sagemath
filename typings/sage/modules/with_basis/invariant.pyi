...
from sage.categories.finitely_generated_semigroups import FinitelyGeneratedSemigroups as FinitelyGeneratedSemigroups
from sage.libs.gap.libgap import libgap as libgap
from sage.matrix.constructor import Matrix as Matrix
from sage.modules.with_basis.representation import Representation as Representation
from sage.modules.with_basis.subquotient import SubmoduleWithBasis as SubmoduleWithBasis
...
class FiniteDimensionalInvariantModule(SubmoduleWithBasis):
    ...
    """
    def __init__(self, M, S, action=..., side: str = 'left', *args, **kwargs) -> None:
        """
        Initialize ``self``.
    ...
    def semigroup(self):
        ...
        """
    semigroup_representation: Incomplete
...
class FiniteDimensionalTwistedInvariantModule(SubmoduleWithBasis):
    ...
    """
    @staticmethod
    def __classcall_private__(cls, M, G, chi, action=..., side: str = 'left', **kwargs):
        '''
        TESTS:
        ...
        '''
    __sided_action__: Incomplete
    def __init__(self, M, G, chi, action=..., side: str = 'left', **kwargs) -> None:
        """
        Initialize ``self``.
