...
from .cardinality import cardinality_bsgs as cardinality_bsgs, cardinality_exhaustive as cardinality_exhaustive
...
class EllipticCurve_finite_field(EllipticCurve_field):
    ...
    def trace_of_frobenius(self):
        ...
        The following shows that the issue from :issue:`2849` is fixed::
            ...
            -27
        """
    def cardinality(self, algorithm=None, extension_degree: int = 1):
        '''
    ...
    def torsion_basis(self, n):
        ...
        """
    def is_isogenous(self, other, field=None, proof: bool = True):
        """
        ...
        When the field is given::
            ...
            False
        """
    def is_supersingular(self, proof: bool = True):
        """
        ...
        TESTS::
            ...
            True
        """
    def is_ordinary(self, proof: bool = True):
        """
        ...
        EXAMPLES::
            ...
            True
        """
    def has_order(self, value, num_checks: int = 8) -> bool:
        '''
        ...
        '''
    def set_order(self, value, *, check: bool = True, num_checks: int = 8) -> None:
        '''
...
supersingular_j_polynomials: Incomplete

def fill_ss_j_dict() -> None:
    """
    ...
    costs.
    """
def supersingular_j_polynomial(p, use_cache: bool = True):
    """
    ...
    """
def is_j_supersingular(j, proof: bool = True):
    """
    ...
    EXAMPLES::
        ...
        [2, 3, 59, 89]
    """
def special_supersingular_curve(F, q=None, *, endomorphism: bool = False):
    '''
    ...
    '''
def EllipticCurve_with_order(m, *, D=None) -> Generator[Incomplete]:
    """
    ...
    """
def EllipticCurve_with_prime_order(N) -> Generator[Incomplete, Incomplete]:
    """
