from . import ell_generic as ell_generic
from .constructor import EllipticCurve as EllipticCurve
from .ell_curve_isogeny import EllipticCurveIsogeny as EllipticCurveIsogeny, isogeny_codomain_from_kernel as isogeny_codomain_from_kernel
...
from sage.schemes.elliptic_curves.ell_point import EllipticCurvePoint_field as EllipticCurvePoint_field
...
class EllipticCurve_field(ell_generic.EllipticCurve_generic, ProjectivePlaneCurve_field):
    ...
    def descend_to(self, K, f=None) -> list:
        ...
        """
    def division_field(self, n, names: str = 't', map: bool = False, **kwds):
        """
        ...
        """
    def isogeny(self, kernel, codomain=None, degree=None, model=None, check: bool = True, algorithm=None, velu_sqrt_bound=None):
        '''
    ...
    def kernel_polynomial_from_point(self, P, *, algorithm=None):
        ...
        """
    def kernel_polynomial_from_divisor(self, f, l, *, check: bool = True):
        """
        ...
        """
    def isogenies_prime_degree(self, l=None, max_l: int = 31) -> list:
        """
        ...
        TESTS::
            ...
            ValueError: 4 is not prime.
        """
    def isogenies_degree(self, n, *, _intermediate: bool = False) -> Generator[Incomplete, None, Incomplete]:
        '''
    ...
    def is_isogenous(self, other, field=None) -> bool:
        ...
        EXAMPLES::
            ...
            NotImplementedError: Only implemented for isomorphic curves over general fields.
        """
    def weierstrass_p(self, prec: int = 20, algorithm=None):
        """
    ...
    def hasse_invariant(self):
        ...
        """
    def isogeny_ell_graph(self, l, directed: bool = True, label_by_j: bool = False):
        '''
