...
class EllipticCurveFactory(UniqueFactory):
    ...
    '''
    def create_key_and_extra_args(self, x=None, y=None, j=None, minimal_twist: bool = True, **kwds):
        """
...
def EllipticCurve_from_c4c6(c4, c6):
    ...
    EXAMPLES::
        ...
        (17, -2005)
    """
def EllipticCurve_from_j(j, minimal_twist: bool = True):
    """
    ...
    setting ``minimal_twist`` to False::
       ...
       True
    """
def coefficients_from_j(j, minimal_twist: bool = True):
    """
    ...
    """
def EllipticCurve_from_cubic(F, P=None, morphism: bool = True):
    """
...
def are_projectively_equivalent(P, Q, base_ring):
    ...
    EXAMPLES::
        ...
        True
    """
def EllipticCurves_with_good_reduction_outside_S(S=[], proof=None, verbose: bool = False):
    """
