...
class Lseries_ell(SageObject):
    ...
    def elliptic_curve(self):
        ...
        """
    def taylor_series(self, a: int = 1, prec: int = 53, series_prec: int = 6, var: str = 'z'):
        """
        ...
        """
    def dokchitser(self, prec: int = 53, max_imaginary_part: int = 0, max_asymp_coeffs: int = 40, algorithm=None):
        '''
