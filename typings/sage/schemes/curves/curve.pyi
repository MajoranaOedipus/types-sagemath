...
from sage.schemes.generic.divisor import Divisor_curve as Divisor_curve
from sage.schemes.generic.divisor_group import DivisorGroup as DivisorGroup
...
class Curve_generic(AlgebraicScheme_subscheme):
    ...
    def divisor_group(self, base_ring=None):
        ...
        EXAMPLES::
            ...
            True
        """
    def divisor(self, v, base_ring=None, check: bool = True, reduce: bool = True):
        """
