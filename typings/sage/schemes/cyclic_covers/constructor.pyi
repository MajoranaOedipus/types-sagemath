from .cycliccover_finite_field import CyclicCover_finite_field as CyclicCover_finite_field
from .cycliccover_generic import CyclicCover_generic as CyclicCover_generic
...
def CyclicCover(r, f, names=None, check_smooth: bool = True):
    '''
