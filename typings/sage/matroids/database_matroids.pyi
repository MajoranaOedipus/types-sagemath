...
from sage.matroids.linear_matroid import BinaryMatroid as BinaryMatroid, QuaternaryMatroid as QuaternaryMatroid, RegularMatroid as RegularMatroid, TernaryMatroid as TernaryMatroid
...
def K4(groundset: str = 'abcdef'):
    ...
    TESTS::
        ...
        [0, 1, 2, 3, 4, 5]
    """
def Whirl3(groundset: str = 'abcdef'):
    """
    The rank-`3` whirl.
...
def R6(groundset: str = 'abcdef'):
    ...
    [Oxl2011]_, p. 642.
    """
def Fano(groundset: str = 'abcdefg'):
    """
    ...
    [Oxl2011]_, p. 643.
    """
def FanoDual(groundset: str = 'abcdefg'):
    """
    ...
    TESTS::
        ...
        [0, 1, 2, 3, 4, 5, 6]
    """
def NonFano(groundset: str = 'abcdefg'):
    """
    ...
    [Oxl2011]_, p. 643-4.
    """
def NonFanoDual(groundset: str = 'abcdefg'):
    """
...
def P7(groundset: str = 'abcdefg'):
    ...
    [Oxl2011]_, p. 644-5.
    """
def AG32(groundset: str = 'abcdefgh'):
    """
...
def P8pp(groundset=None):
    ...
    [Oxl2011]_, p. 651.
    """
def Wheel4(groundset: str = 'abcdefgh'):
    """
    ...
    [Oxl2011]_, p. 651-2.
    """
def Whirl4(groundset: str = 'abcdefgh'):
    """
    ...
    [Oxl2011]_, p. 652.
    """
def K33dual(groundset: str = 'abcdefghi'):
    """
    ...
    [Oxl2011]_, p. 652-3.
    """
def K33(groundset: str = 'abcdefghi'):
    """
    ...
    [Oxl2011]_, p. 652-3.
    """
def AG23(groundset: str = 'abcdefghi'):
    """
    ...
    [Oxl2011]_, p. 653.
    """
def TernaryDowling3(groundset: str = 'abcdefghi'):
    """
...
def NonPappus(groundset=None):
    ...
    [Oxl2011]_, p. 655.
    """
def K5(groundset: str = 'abcdefghij'):
    """
    ...
    [Oxl2011]_, p. 656.
    """
def K5dual(groundset: str = 'abcdefghij'):
    """
    ...
    [Oxl2011]_, p. 656.
    """
def R10(groundset: str = 'abcdefghij'):
    """
...
def NonDesargues(groundset=None):
    ...
    [Oxl2011]_, p. 657.
    """
def R12(groundset: str = 'abcdefghijkl'):
    """
    ...
    [Oxl2011]_, p. 657.
    """
def ExtendedTernaryGolayCode(groundset: str = 'abcdefghijkl'):
    """
    ...
    [Oxl2011]_, p. 658.
    """
def T12(groundset: str = 'abcdefghijkl'):
    """
...
def AG(n, q, x=None, groundset=None):
    ...
    [Oxl2011]_, p. 661.
    """
def Z(r, t: bool = True, groundset=None):
    """
    ...
    [Oxl2011]_, p. 661-2.
    """
def Spike(r, t: bool = True, C3=[], groundset=None):
    """
...
def NonVamos(groundset=None):
    ...
    [Oxl2011]_, p. 72, 84.
    """
def NotP8(groundset: str = 'abcdefgh'):
    """
...
def AG23minus(groundset=None):
    ...
    [Oxl2011]_, p. 653.
    """
def P9(groundset: str = 'abcdefghi'):
    '''
...
def TicTacToe(groundset=None):
    ...
    [Hoc]_
    """
def N1(groundset: str = 'abcdefghij'):
    """
...
def Block_10_5(groundset=None):
    ...
    EXAMPLES::
        ...
        (True, (3, 10, 5, 3))
    """
def Q10(groundset: str = 'abcdefghij'):
    """
...
def BetsyRoss(groundset=None):
    ...
    EXAMPLES::
        ...
        True
    """
def N2(groundset: str = 'abcdefghijkl'):
    """
    ...
    [Oxl2011]_, p. 554.
    """
def D16(groundset: str = 'abcdefghijklmnop'):
    """
    ...
    [CMO2012]_
    """
def Terrahawk(groundset: str = 'abcdefghijklmnop'):
    """
    ...
    [CMO2011]_
    """
def ExtendedBinaryGolayCode(groundset: str = 'abcdefghijklmnopqrstuvwx'):
    """
