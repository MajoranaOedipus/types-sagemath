...
class lfun_generic:
    ...
    residues: Incomplete
    prec: Incomplete
    def __init__(self, conductor, gammaV, weight, eps, poles=[], residues: str = 'automatic', prec=None, *args, **kwds) -> None:
        """
        ...
        EXAMPLES::
            ...
            sage: lf = lfun_generic(conductor=1, gammaV=[0], weight=1, eps=1, poles=[1], residues=[1])
        """
    def init_coeffs(self, v, cutoff=None, w: int = 1) -> None:
        '''
...
class LFunction(SageObject):
    ...
    def derivative(self, s, D: int = 1):
        ...
        EXAMPLES::
            ...
            -0.937548254315844
        """
    def taylor_series(self, s, k: int = 6, var: str = 'z'):
        '''
