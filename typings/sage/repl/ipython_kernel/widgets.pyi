...
from ipywidgets.widgets import ColorPicker, FloatRangeSlider, FloatSlider, HBox, HTMLMath, IntRangeSlider, IntSlider, Text, Textarea, ValueWidget
...
class Grid(TransformWidget, HBox, ValueWidget):
    ...
    cols: Incomplete
    children: Incomplete
    def __init__(self, nrows, ncols, make_widget, description: str = '', transform=None) -> None:
        '''
