...
from sage.coding.linear_rank_metric import AbstractLinearRankMetricCode as AbstractLinearRankMetricCode
...
class GabidulinCode(AbstractLinearRankMetricCode):
    ...
    """
    def __init__(self, base_field, length, dimension, sub_field=None, twisting_homomorphism=None, evaluation_points=None) -> None:
        """
...
class GabidulinPolynomialEvaluationEncoder(Encoder):
    ...
    def message_space(self):
        ...
        """
    def encode(self, p, form: str = 'vector'):
        '''
