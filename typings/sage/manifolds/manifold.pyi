...
from sage.manifolds.structure import DifferentialStructure as DifferentialStructure, RealDifferentialStructure as RealDifferentialStructure, RealTopologicalStructure as RealTopologicalStructure, TopologicalStructure as TopologicalStructure
...
class TopologicalManifold(ManifoldSubset):
    ...
    '''
    def __init__(self, n, name, field, structure, base_manifold=None, latex_name=None, start_index: int = 0, category=None, unique_tag=None) -> None:
        """
    ...
    def start_index(self):
        ...
        EXAMPLES::
            ...
            1
        """
    def irange(self, start=None, end=None) -> Generator[Incomplete]:
        """
        ...
        In general, one has always::
            ...
            True
        """
    def index_generator(self, nb_indices) -> Generator[Incomplete]:
        '''
    ...
    def default_chart(self):
        ...
        Default chart on a 2-dimensional manifold and on some subsets::
            ...
            Chart (A, (t, z))
        """
    def set_default_chart(self, chart) -> None:
        """
    ...
    def is_manifestly_coordinate_domain(self):
        ...
        EXAMPLES::
            ...
            True
        """
    def chart(self, coordinates: str = '', names=None, calc_method=None, coord_restrictions=None) -> Chart:
        '''
    ...
    def scalar_field_algebra(self):
        ...
        The output is cached::
            ...
            True
        """
    def scalar_field(self, coord_expression=None, chart=None, name=None, latex_name=None) -> ScalarField:
        """
    ...
    class options(GlobalOptions):
        ...
        module: str
        option_class: str
        textbook_output: Incomplete
        omit_function_arguments: Incomplete
    def continuous_map(self, codomain, coord_functions=None, chart1=None, chart2=None, name=None, latex_name=None):
        """
        ...
        """
    def homeomorphism(self, codomain, coord_functions=None, chart1=None, chart2=None, name=None, latex_name=None):
        """
    ...
    def set_calculus_method(self, method) -> None:
        """
...
def Manifold(dim: int, name: str | None, latex_name: str | None = None, field: str = 'real', structure: str | None = None, start_index: int = 0, **extra_kwds) -> TopologicalManifold | DifferentiableManifold:
    '''
