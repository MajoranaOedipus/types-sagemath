...
from sage.categories.vector_bundles import VectorBundles as VectorBundles
from sage.manifolds.vector_bundle import TopologicalVectorBundle as TopologicalVectorBundle
...
class DifferentiableVectorBundle(TopologicalVectorBundle):
    ...
    differentiability degree as the base manifold::
        ...
        True
    """
    def __init__(self, rank, name, base_space, field: str = 'real', latex_name=None, category=None, unique_tag=None) -> None:
        """
    ...
    def bundle_connection(self, name, latex_name=None):
        ...
        .. SEEALSO::
            ...
            :class:`~sage.manifolds.differentiable.bundle_connection.BundleConnection`.
        """
    def characteristic_cohomology_class_ring(self, base=...):
        """
    ...
    def characteristic_cohomology_class(self, *args, **kwargs):
        ...
        """
    characteristic_class: Incomplete
    ...
    def coframes(self):
        ...
        Coframes on subsets of `\\RR^2`::
            ...
            [Coordinate coframe (R^2, (dx,dy)),
             ...
             Coframe (U, (e^0,e^1))]
        """
    def trivialization(self, coordinates: str = '', names=None, calc_method=None):
        '''
