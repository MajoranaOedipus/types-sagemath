...
from sage.manifolds.structure import DegenerateStructure as DegenerateStructure
...
class DegenerateManifold(DifferentiableManifold):
    ...
    def __init__(self, n, name, metric_name=None, signature=None, base_manifold=None, diff_degree=..., latex_name=None, metric_latex_name=None, start_index: int = 0, category=None, unique_tag=None) -> None:
        ...
        """
    def metric(self, name=None, signature=None, latex_name=None, dest_map=None) -> DegenerateMetric:
        """
