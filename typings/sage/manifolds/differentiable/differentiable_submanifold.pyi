...
from sage.manifolds.topological_submanifold import TopologicalSubmanifold as TopologicalSubmanifold
...
class DifferentiableSubmanifold(DifferentiableManifold, TopologicalSubmanifold):
    ...
    *embedded submanifold* of `M` (or simply a *submanifold*).
    ...
    '''
    def __init__(self, n, name, field, structure, ambient=None, base_manifold=None, diff_degree=..., latex_name=None, start_index: int = 0, category=None, unique_tag=None) -> None:
        """
