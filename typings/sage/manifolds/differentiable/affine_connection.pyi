...
class AffineConnection(SageObject):
    ...
    def add_coef(self, frame=None):
        ...
        """
    def del_other_coef(self, frame=None) -> None:
        """
    ...
    def __setitem__(self, args, value) -> None:
        ...
        Providing a scalar field as value::
            ...
            x*y
        """
    def display(self, frame=None, chart=None, symbol=None, latex_symbol=None, index_labels=None, index_latex_labels=None, coordinate_labels: bool = True, only_nonzero: bool = True, only_nonredundant: bool = False):
        """
