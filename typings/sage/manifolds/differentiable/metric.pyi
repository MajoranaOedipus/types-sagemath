...
class PseudoRiemannianMetric(TensorField):
    ...
    `-r g_{j[k} \\delta^i_{\\ \\, l]}`::
        ...
        True
    """
    def __init__(self, vector_field_module, name, signature=None, latex_name=None) -> None:
        """
        Construct a metric.
    ...
    def set(self, symbiform) -> None:
        ...
        non-parallelizable 2-dimensional manifold::
            ...
            g = (1/8*u^2 - 1/8*v^2 + 1/4*v + 1/2) du⊗du + 1/4*u du⊗dv
             + 1/4*u dv⊗du + (-1/8*u^2 + 1/8*v^2 + 1/4*v + 1/2) dv⊗dv
        """
    def inverse(self, expansion_symbol=None, order: int = 1):
        """
        ...
        Let us check that ``ginv`` is indeed the inverse of ``g``::
            ...
            True
        """
    def connection(self, name=None, latex_name=None, init_coef: bool = True):
        """
    ...
    def christoffel_symbols(self, chart=None):
        ...
        the method :meth:`christoffel_symbols_display`::
            ...
            Gam^ph_th,ph = cos(th)/sin(th)
        """
    def christoffel_symbols_display(self, chart=None, symbol=None, latex_symbol=None, index_labels=None, index_latex_labels=None, coordinate_labels: bool = True, only_nonzero: bool = True, only_nonredundant: bool = True):
        """
