...
class TangentVector(FiniteRankFreeModuleElement):
    ...
    def __init__(self, parent, name=None, latex_name=None) -> None:
        ...
        """
    def plot(self, chart=None, ambient_coords=None, mapping=None, color: str = 'blue', print_label: bool = True, label=None, label_color=None, fontsize: int = 10, label_offset: float = 0.1, parameters=None, **extra_options):
        """
