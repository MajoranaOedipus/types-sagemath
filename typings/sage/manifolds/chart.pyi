...
from sage.manifolds.calculus_method import CalculusMethod as CalculusMethod
from sage.manifolds.chart_func import ChartFunctionRing as ChartFunctionRing
...
class Chart(UniqueRepresentation, SageObject):
    ...
    '''
    @staticmethod
    def __classcall__(cls, domain, coordinates: str = '', calc_method=None, names=None, coord_restrictions=None, **coordinate_options):
        '''
    ...
    def codomain(self):
        ...
        """
    def transition_map(self, other, transformations, intersection_name=None, restrictions1=None, restrictions2=None):
        """
...
class RealChart(Chart):
    ...
    *and* `x < 0`::
    ...
    :meth:`plot`.
    '''
    def __init__(self, domain, coordinates, calc_method=None, bounds=None, periods=None, coord_restrictions=None) -> None:
        """
    ...
    def valid_coordinates_numerical(self, *coordinates):
        ...
        (`x > 0` and `|y| < 1`)::
            ...
            True
        """
    def plot(self, chart=None, ambient_coords=None, mapping=None, fixed_coords=None, ranges=None, number_values=None, steps=None, parameters=None, **kwds):
        """
...
class CoordChange(SageObject):
    ...
    def inverse(self):
        ...
        We have as well::
            ...
            True
        """
    def set_inverse(self, *transformations, **kwds) -> None:
        '''
