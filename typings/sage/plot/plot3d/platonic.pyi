from .index_face_set import IndexFaceSet as IndexFaceSet
from .shapes import Box as Box, ColorCube as ColorCube
from .shapes2 import frame3d as frame3d
...
def prep(G, center, size, kwds):
    ...
    and that keywords are passed (see :issue:`10796`)::
        ...
        Graphics3d Object
    """
def tetrahedron(center=(0, 0, 0), size: int = 1, **kwds):
    """
    A 3d tetrahedron.
    ...
    """
def cube(center=(0, 0, 0), size: int = 1, color=None, frame_thickness: int = 0, frame_color=None, **kwds):
    """
    ...
    - William Stein
    """
def octahedron(center=(0, 0, 0), size: int = 1, **kwds):
    """
    ...
    .. PLOT::
        ...
        sphinx_plot(G)
    """
def dodecahedron(center=(0, 0, 0), size: int = 1, **kwds):
    """
    A dodecahedron.
    ...
    """
def icosahedron(center=(0, 0, 0), size: int = 1, **kwds):
    """
    An icosahedron.
