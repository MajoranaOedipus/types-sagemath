from . import ambient_R as ambient_R, defaults as defaults
from .ambient_eps import ModularFormsAmbient_eps as ModularFormsAmbient_eps
from .ambient_g0 import ModularFormsAmbient_g0_Q as ModularFormsAmbient_g0_Q
from .ambient_g1 import ModularFormsAmbient_g1_Q as ModularFormsAmbient_g1_Q, ModularFormsAmbient_gH_Q as ModularFormsAmbient_gH_Q
...
def canonical_parameters(group, level, weight, base_ring):
    ...
    """
def ModularForms_clear_cache() -> None:
    """
    ...
    ::
        ...
        {}
    """
def ModularForms(group: int = 1, weight: int = 2, base_ring=None, eis_only: bool = False, use_cache: bool = True, prec=...):
    """
    ...
    """
def CuspForms(group: int = 1, weight: int = 2, base_ring=None, use_cache: bool = True, prec=...):
    """
    ...
    """
def EisensteinForms(group: int = 1, weight: int = 2, base_ring=None, use_cache: bool = True, prec=...):
    """
    ...
    EXAMPLES::
        ...
        Eisenstein subspace of dimension 1 of Modular Forms space of dimension 2
         for Congruence Subgroup Gamma0(11) of weight 2 over Rational Field
    """
def Newforms(group, weight: int = 2, base_ring=None, names=None):
    """
    ...
    Check that :issue:`15486` is fixed (this used to take over a day)::
        ...
        3
    """
def Newform(identifier, group=None, weight: int = 2, base_ring=..., names=None):
    """
    INPUT:
