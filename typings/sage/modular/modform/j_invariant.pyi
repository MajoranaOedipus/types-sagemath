from .eis_series import eisenstein_series_qexp as eisenstein_series_qexp
from .vm_basis import delta_qexp as delta_qexp
from sage.rings.rational_field import QQ as QQ

def j_invariant_qexp(prec: int = 10, K=...):
    """
