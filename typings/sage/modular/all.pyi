...
from sage.modular.arithgroup.all import (
    ...
    CongruenceSubgroup as CongruenceSubgroup,
    FareySymbol as FareySymbol,
    Gamma as Gamma,
    Gamma0 as Gamma0,
    Gamma1 as Gamma1,
    GammaH as GammaH,
...
from sage.modular.cusps_nf import (
    Gamma0_NFCusps as Gamma0_NFCusps,
    NFCusp as NFCusp,
    NFCusps as NFCusps,
)
from sage.modular.dirichlet import (
    DirichletGroup as DirichletGroup,
    kronecker_character as kronecker_character,
    kronecker_character_upside_down as kronecker_character_upside_down,
    trivial_character as trivial_character,
)
from sage.modular.etaproducts import (
    AllCusps as AllCusps,
    CuspFamily as CuspFamily,
    EtaGroup as EtaGroup,
    EtaGroupElement as EtaGroupElement,
    EtaProduct as EtaProduct,
)
from sage.modular.multiple_zeta import Multizeta as Multizeta, Multizetas as Multizetas
from sage.modular.modform.numerical import NumericalEigenforms
numerical_eigenforms = NumericalEigenforms