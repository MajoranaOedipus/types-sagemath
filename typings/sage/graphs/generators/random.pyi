...
from sage.misc.randstate import current_randstate as current_randstate, set_random_seed as set_random_seed

def RandomGNP(n, p, seed=None, fast: bool = True, algorithm: str = 'Sage'):
    """
...
def RandomBarabasiAlbert(n, m, seed=None):
    ...
    When `m = 1`, the generated graph is a tree::
        ...
        True
    """
def RandomBipartite(n1, n2, p, set_position: bool = False, seed=None):
    """
    ...
    """
def RandomRegularBipartite(n1, n2, d1, set_position: bool = False, seed=None):
    """
    ...
    """
def RandomBlockGraph(m, k, kmax=None, incidence_structure: bool = False, seed=None):
    """
...
def RandomBoundedToleranceGraph(n, seed=None):
    ...
    """
def RandomGNM(n, m, dense: bool = False, seed=None):
    """
...
def pruned_tree(T, f, s):
    ...
    EXAMPLES::
        ...
        11
    """
def RandomChordalGraph(n, algorithm: str = 'growing', k=None, l=None, f=None, s=None, seed=None):
    '''
...
def RandomTree(n, seed=None):
    ...
    Random tree with one and zero vertices::
        ...
        Graph on 1 vertex
    """
def RandomTreePowerlaw(n, gamma: int = 3, tries: int = 1000, seed=None):
    """
...
def RandomToleranceGraph(n, seed=None):
    ...
    TESTS::
        ...
        ValueError: the number `n` of vertices must be >= 0
    """
def RandomTriangulation(n, set_position: bool = False, k: int = 3, seed=None):
    """
    ...
    """
def blossoming_contour(t, shift: int = 0, seed=None):
    """
...
def RandomBicubicPlanar(n, seed=None):
    ...
    """
def RandomUnitDiskGraph(n, radius: float = 0.1, side: int = 1, seed=None):
    """
