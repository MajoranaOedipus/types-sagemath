...
def ChessboardGraphGenerator(dim_list, rook: bool = True, rook_radius=None, bishop: bool = True, bishop_radius=None, knight: bool = True, knight_x: int = 1, knight_y: int = 2, relabel: bool = False):
    """
    ...
    """
def QueenGraph(dim_list, radius=None, relabel: bool = False):
    '''
    ...
    '''
def KingGraph(dim_list, radius=None, relabel: bool = False):
    """
    ...
    Also ``True`` in higher dimensions::
        ...
        True
    """
def KnightGraph(dim_list, one: int = 1, two: int = 2, relabel: bool = False):
    """
    ...
    The `(6,6)`-Knight Graph is Hamiltonian::
        ...
        True
    """
def RookGraph(dim_list, radius=None, relabel: bool = False):
    """
    ...
    When the radius is 1, the Rook's Graph is a grid::
        ...
        True
    """
def BishopGraph(dim_list, radius=None, relabel: bool = False):
    '''
