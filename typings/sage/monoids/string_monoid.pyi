from .free_monoid import FreeMonoid as FreeMonoid
from .string_monoid_element import StringMonoidElement as StringMonoidElement
from .string_ops import strip_encoding as strip_encoding
...
class BinaryStringMonoid(StringMonoid_class):
    ...
    def __call__(self, x, check: bool = True):
        ...
        EXAMPLES::
            ...
            1
        """
    def encoding(self, S, padic: bool = False):
        """
...
class AlphabeticStringMonoid(StringMonoid_class):
    ...
    def __call__(self, x, check: bool = True):
        ...
        EXAMPLES::
            ...
            ABCDEFGHIJKLMNOPQRSTUVWXYZ
        """
    def characteristic_frequency(self, table_name: str = 'beker_piper'):
        '''
