...
from typing import Annotated, Any, Literal, Self, SupportsInt, overload
from typings_sagemath import CmpOperator
...
type _ConvertableToGen = object
type _PariType = Literal[
    "t_INT",
    "t_REAL",
    "t_INTMOD",
    "t_FRAC",
...
class Gen_base:
    centerlift: Incomplete
    lngamma: Incomplete
    znorder: Incomplete
    polredbest: Incomplete
    polred: Incomplete
    ...
...
class Gen(Gen_base):
    ...
    def __hash__(self) -> int:
        ...
        True
        """
    def __iter__(self) -> Generator[int] | Generator[str]:
        """
        ...
        ['h', 'e', 'l', 'l', 'o']
        """
    def list(self) -> list[int] | list[str]:
        """
        ...
        [[1, 2, 3]~, [4, 5, 6]~]
        """
    def __reduce__(self) -> tuple[Callable[[object], Gen], tuple[str]]:
        """
        Examples:
        ...
        True
        """
    def __add__(left, right: _ConvertableToGen) -> Gen:
        """
        ...
        1
        """
    def __sub__(left, right: _ConvertableToGen) -> Gen:
        """
        ...
        -5
        """
    def __mul__(left, right: _ConvertableToGen) -> Gen: ...
    def __div__(left, right: _ConvertableToGen) -> Gen: ...
    def __truediv__(left, right: _ConvertableToGen) -> Gen:
        """
        Examples:
        ...
        (x^2 + 2*x + 3)/x
        """
    def __floordiv__(left, right: _ConvertableToGen) -> Gen:
        """
        Examples:
        ...
        x + 2
        """
    def __mod__(left, right: _ConvertableToGen) -> Gen:
        """
        ...
        1
        """
    def __pow__(left, right: _ConvertableToGen, m: _ConvertableToGen | None):
        """
        ...
        1/32
        """
    def __neg__(self) -> Gen: ...
    def __rshift__(self, n: int) -> Gen:
        """
    ...
    def __lshift__(self, n: int) -> Gen:
        ...
        132
        """
    def __invert__(self) -> Gen: ...
    def getattr(self, attr: str | bytes) -> Gen:
        """
    ...
    def bnf_get_reg(self) -> Gen:
        ...
        2.66089858019037...
        """
    def idealmoddivisor(self, ideal: Gen) -> Gen:
        """
    ...
    def bid_get_gen(self) -> Gen:
        ...
        """
    def __getitem__(self, n: SupportsInt | tuple[SupportsInt, SupportsInt] | slice) -> Gen | Incomplete:
        """
        ...
        """
    @overload
    def __setitem__(self, n: SupportsInt | tuple[SupportsInt, SupportsInt], y: _ConvertableToGen) -> None: ...
    @overload
    def __setitem__(self, n: slice, y: Sequence[object]) -> None:
        r"""
    ...
    def __richcmp__(self, right: _ConvertableToGen, op: CmpOperator) -> bool: 
        """
        ...
        True
        """
    def cmp(self, right: Gen_base) -> Literal[-1, 0, 1]:
        """
    ...
    def __index__(self) -> int:
        ...
        ...     assert hex(pari(-i)) == hex(-i)
        """
    def python_list_small(self) -> list[int]:
        """
    ...
    def python_list(self) -> list[Gen]:
        ...
        [1, 2, 3]
        """
    type _Python = int | Fraction | float | complex | list[_Python] | str
    def python(self) -> _Python:
        """
    ...
    type _Sage = Integer | Rational | RealNumber | ComplexNumber | NumberFieldElement_quadratic | list[_Sage] | list[int] | str | Matrix | pAdicGenericElement | PlusInfinity | SageObject
    def sage(self, locals: dict[str, Any] | None = None) -> _Sage:
        r"""
    ...
    def __nonzero__(self) -> bool:
        ...
        False
        """
    def gequal(a, b: _ConvertableToGen) -> bool: 
        r"""
    ...
    def gequal_long(a, b: int) -> bool: 
        ...
        False
        """
    def isprime(self, flag: Literal[0, 1, 2, 3] = 0) -> bool:
        """
        ...
        """
    @overload
    def ispseudoprime(self, flag: Literal[0] = 0) -> bool: ...
    @overload
    def ispseudoprime(self, flag: Annotated[int, "positive"]) -> bool: # TODO: The document says that this could be tuple, but I cannot see from the source code
        """
        ...
        False
        """
    def ispower(self, k: int | None = None) -> tuple[int, Gen]:
        r"""
        ...
        (1, 2)
        """
    def isprimepower(self) -> tuple[int, Gen] | tuple[Literal[0], Self]:
        r"""
        ...
        (12345, 3)
        """
    def ispseudoprimepower(self) -> tuple[int, Gen] | tuple[Literal[0], Self]:
        r"""
    ...
    def vecmin(x) -> Gen: 
        ...
        -5/3
        """
    def Ser(f, v: Gen | str | bytes| None = None, precision: int =-1) -> Gen: 
        """
    ...
    def padicprime(self) -> Incomplete:
        """
        ...
        """
    @overload
    def round(x, estimate: Literal[True]) -> tuple[Gen, Gen]: ... 
    @overload
    def round(x, estimate: Literal[False] = False) -> Gen: 
        """
    ...
    def sizebyte(x) -> int:
        ...
        """
    @overload
    def truncate(x, estimate: Literal[True]) -> tuple[Gen, Gen]: ... 
    @overload
    def truncate(x, estimate: Literal[False] = False) -> Gen:
        """
    ...
    def bernreal(self): ...
    @overload
    def bernreal(self, precision: int) -> Gen:
        r"""
        ...
        """
    @overload
    def besselk(nu, x: _ConvertableToGen) -> Gen:  ...
    @overload
    def besselk(nu, x: _ConvertableToGen, precision: int) -> Gen:
        """
        ...
        """
    def eint1(x, n: int = 0, precision: int = ...) -> Gen:
        r"""
    ...
    def polylog(x, m: int, flag: int = 0, precision: int = ...) -> Gen:
        """
        ...
        -0.400459056163451
        """
    def sqrtn(x, n: int, precision: int = ...):
        r"""
    ...
    def fibonacci(self) -> Gen:
        ...
        """
    @overload
    def issquare(x, find_root: Literal[True]) -> tuple[Literal[True], Gen] | tuple[Literal[False], None]: ...
    @overload
    def issquare(x, find_root: Literal[False] = False) -> bool:
        """
        issquare(x,n): ``True`` if x is a square, ``False`` if not. If
        ``find_root`` is given, also returns the exact square root.
        """
    def issquarefree(self) -> bool:
        """
        Examples:
    ...
    def sumdivk(n, k: int) -> Gen:
        ...
        130
        """
    def Zn_issquare(self, n: _ConvertableToGen) -> Gen:
        """
        ...
        """
    def Zn_sqrt(self, n: _ConvertableToGen) -> Gen:
        """
        ...
        """
    @overload
    def ellan(self, n: int, python_ints: Literal[True]) -> list[int]: ...
    @overload
    def ellan(self, n: int, python_ints: Literal[False] = False) -> Gen:
        """
        ...
        """
    @overload
    def ellaplist(self, n: int, python_ints: Literal[True]) -> list[int]: ...
    @overload
    def ellaplist(self, n: int, python_ints: Literal[False] = False) -> Gen:
        r"""
        ...
        ([], <... 'list'>)
        """
    def ellisoncurve(self, x: _ConvertableToGen) -> bool:
        """
        ...
        True
        """
    def ellminimalmodel(self) -> tuple[Gen, Gen]:
        """
    ...
    def j(self) -> Gen:
        ...
        [-1, 1; 2, 12; 11, -5; 31, 3]
        """
    def galoissubfields(self, flag = 0, v = None) -> Gen: #TODO: check galoisfixedfield
        """
        ...
        """
    def nfeltval(self, x: _ConvertableToGen, p: _ConvertableToGen) -> Incomplete: # TODO: nfval?
        """
        ...
        """
    @overload
    def nfbasis(self, flag: int) -> Gen: ...
    @overload
    def nfbasis(self, flag: Literal[0] = 0, fa: _ConvertableToGen | None = None) -> Gen:
        r"""
        ...
        """
    @overload
    def nfbasis_d(self, flag: Literal[0] = 0, fa: _ConvertableToGen | None = None) -> tuple[Gen, Gen]: ...
    @overload
    def nfbasis_d(self, flag: int = 1) -> tuple[Gen, Gen]:
        """
        ...
        ([1, x, x^2], -108)
        """
    def nfbasistoalg_lift(nf, x: _ConvertableToGen) -> Gen:
        r"""
        ...
        -5/3*x^2 + 5/3*x - 1/6
        """
    def nfgenerator(self) -> Incomplete: ... # TODO: Mod?
    @overload
    def eval(self, *args) -> Gen | None: ...
    @overload
    def eval(self, **kwds) -> Gen | None:
        """
        ...
        """
    @overload
    def __call__(self, *args) -> Gen | None: ...
    @overload
    def __call__(self, **kwds) -> Gen | None:
        """
    ...
    def arity(self) -> int:
        ...
        3
        """
    def factorpadic(self, p: _ConvertableToGen, r: int = 20) -> Gen:
        """
    ...
    def lllgram(self): ...
    def lllgramint(self): ...
    def qfrep(self, B: _ConvertableToGen, flag: int = 0):
        """
        ...
        """
    def matkerint(self, flag: _NotUsed = 0):
        """
        ...
        [1; -2]
        """
    def factor(self, limit: int = -1, proof: bool | None=None) -> Gen:
        """
    ...
    def __abs__(self) -> Incomplete: ...    # TODO: abs?
    def nextprime(self, add_one: bool = False) -> Gen:
        """
        ...
        """
    def change_variable_name(self, var:  Gen | str | bytes) -> Gen:
        """
        ...
        0
        """
    def nf_subst(self, z: _ConvertableToGen) -> Gen:
        """
    ...
    def type(self) -> _PariType:
        ...
        't_INFINITY'
        """
    def polinterpolate(self, ya: _ConvertableToGen, x: _ConvertableToGen) -> tuple[Gen, Gen]:
        """
        ...
        returned value.
        """
    def ellwp(self, z: _ConvertableToGen = 'z', n: int =20, flag: int = 0, precision: int =...) -> Gen:
        """
        ...
        """
    def debug(self, depth: int = -1) -> None:
        r"""
...
def objtogen(s: _ConvertableToGen) -> Gen:
    """
